...
<link rel="stylesheet" type="text/css"
	href="${rootPath}/resources/css/main.css?ver=2019081901">
<link rel="stylesheet" type="text/css"
...
<%@include file="/WEB-INF/views/body/ems/list2.jspf" %>
			</c:when>
			<c:when test="${BODY == 'BBS_VIEW' }">
<%@include file="/WEB-INF/views/body/ems/view2.jspf" %>
			</c:when>
			<c:when test="${BODY == 'BBS_WRITE' }">
<%@include file="/WEB-INF/views/body/ems/write2.jspf" %>
			</c:when>
