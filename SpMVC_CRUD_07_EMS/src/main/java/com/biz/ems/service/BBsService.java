...
import com.biz.ems.mapper.BBsDao;
...
public class BBsService {
	...
	/*
	 * 글쓰기를 수행할때 file을 같이 updload를 수행하면 해당하는 글의 bbs_seq를 조회하여 file table에 저장할때 같이
	 * 저장을 수행 해줘야 한다.
	 * 
	 * 1. 게시글을 저장하고 2. 게시글의 bbs_seq를 조회하여 3. 파일정보를 insert할때 해당하는 bbs_seq를 같이 저장해주야
	 * 한다. 그래야 게시글을 조회할때 해당하는 파일들을 같이 조회할수 있다.
	 */
